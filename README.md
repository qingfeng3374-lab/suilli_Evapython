# suilli_Evapython
suilli_Evapython是一款专为Python学习者打造的在线代码评测平台，致力于提供优质的编程学习体验。 平台集成了先进的Monaco代码编辑器，支持实时代码编写和评测。用户可以在友好的界面中解决精心设计的编程题目，从基础语法到算法挑战，涵盖三个难度等级。系统提供15秒安全评测机制，确保代码执行的稳定性和安全性。
# suilli_Evapython - Python代码评测平台
